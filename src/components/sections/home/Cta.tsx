...
export default function Cta() {
  ...
  const stats = [
    { value: '$2.5B+', label: 'Deals Closed', icon: Award },
    { value: '500+', label: 'Corporate Clients', icon: Users },
    { value: '98%', label: 'Success Rate', icon: Scale },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                From complex M&A transactions to intellectual property protection, Sterling &
                Associates delivers strategic legal solutions that drive business success and
                minimize risk.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Representing Fortune 500 companies and emerging enterprises
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">No-Cost Consultation</h3>
              <p className="text-sm text-muted-foreground">
                Initial case evaluation at no charge to you
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Attorney-client privilege and data protection guaranteed
              </p>
            </div>
